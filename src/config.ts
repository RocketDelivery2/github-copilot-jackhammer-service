...
const ConfigSchema = z.object({
  ...
  OPENAI_MODEL_QUEUE: z.string().default('gpt-5.6-terra'),
  OPENAI_MODEL_CONTINUATION: z.string().default('gpt-5.6-luna'),
  OPENAI_PROMPT_CACHE_ENABLED: boolish.default('true'),
  OPENAI_PROMPT_CACHE_RETENTION: z.enum(['in_memory', '24h']).default('24h'),
  OPENAI_MAX_OUTPUT_TOKENS_QUEUE: z.coerce.number().int().positive().default(1200),
  OPENAI_MAX_OUTPUT_TOKENS_CONTINUATION: z.coerce.number().int().positive().default(256),
